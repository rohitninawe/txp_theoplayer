...
import com.txptheoplayer.databinding.ActivityFullscreenBinding;

import static android.view.ViewGroup.LayoutParams.MATCH_PARENT;

public class CustomTheoFullScreen extends FullScreenActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        theoFullScreenManager.requestFullScreen();
